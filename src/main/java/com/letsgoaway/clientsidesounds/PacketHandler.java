...
import static com.letsgoaway.clientsidesounds.ClientSideSounds.executor;
    ...
    public void channelRead(ChannelHandlerContext context, Object packet) throws Exception {
        ...
        try {
            if (packet instanceof S29PacketSoundEffect) {
                ...
                if (!PacketHandler.blocks.contains(blockPlacePacket.getX() + " " + blockPlacePacket.getY() + " " + blockPlacePacket.getZ())) {
